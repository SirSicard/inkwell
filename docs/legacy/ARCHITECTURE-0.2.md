# Architecture of Inkwell 0.2 (legacy)

> The Tauri app, frozen on the `legacy/0.2` branch. Inkwell 1.0 is a different architecture: see [../ARCHITECTURE.md](../ARCHITECTURE.md). The pipeline stages below are what 1.0's dictation chain ports.
